"""
Django settings for elakscam project.
...
SECRET_KEY = 'django-insecure-zvrs3(_b-4_tmxie-6ezvsf*b7f)6z@7+!u%vz&d7pcz%=bb83'
...
WSGI_APPLICATION = 'elakscam.wsgi.application'
